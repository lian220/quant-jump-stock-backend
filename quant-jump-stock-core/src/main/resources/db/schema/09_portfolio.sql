-- ============================================
-- 09_portfolio.sql
-- Sources: V10 + V51 (preferred_universe_type already in 06_strategies.sql)
-- ============================================
...
-- ============================================
-- strategy_subscriptions에 portfolio_id FK 추가 (user_portfolios 생성 이후)
-- ============================================
ALTER TABLE strategy_subscriptions
    ADD CONSTRAINT fk_sub_portfolio
