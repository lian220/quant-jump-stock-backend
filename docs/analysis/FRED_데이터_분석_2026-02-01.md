...
### 분석 결과
- [데이터 형식 분석](./데이터_형식_분석.md) - 데이터 저장 형식 평가
...
- [스케줄러 아키텍처](../architecture/스케줄러_아키텍처.md) - 데이터 수집 스케줄

### 설정 가이드
- [환경설정 가이드](../setup/환경설정_가이드.md) - FRED API 키 설정
- [로컬 테스트 가이드](../setup/로컬_테스트_가이드.md) - 데이터 수집 테스트
