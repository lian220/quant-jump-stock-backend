...
### 분석 기능
- [인공지능분석.md](./인공지능분석.md) - Vertex AI 예측 기능
- [데이터수집.md](./데이터수집.md) - 경제 데이터 수집
- [ANALYSIS_아키텍처.md](../아키텍처.md) - 분석 시스템 전체

### API 명세
- [Predictions API](/docs/api/예측.md) - 예측 결과 조회 API
- [ML API](/docs/api/머신러닝_에이피아이.md) - Vertex AI 관리 API

### 데이터베이스
- [스키마.md](../../database/스키마.md) - MongoDB 스키마
