...
### 아키텍처
- [이벤트 기반 아키텍처](./이벤트_기반_아키텍처.md) - 전체 이벤트 아키텍처
- [시스템 아키텍처](./시스템_아키텍처.md) - 시스템 전체 구조
- [스케줄러 아키텍처](./스케줄러_아키텍처.md) - Quartz 스케줄러 이벤트 발행

### 설정 가이드
- [환경설정 가이드](../setup/환경설정_가이드.md) - Kafka 설정
- [Slack 설정 가이드](../setup/Slack_설정_가이드.md) - 알림 이벤트 연동

### 개발 가이드
- [코드 스타일](../guidelines/CODE_STYLE.md) - 이벤트 코딩 컨벤션
