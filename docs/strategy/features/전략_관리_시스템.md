...
### Jira 계획
- [Jira 티켓 계획](../../../../docs/product/jira-ticket-plan.md) - 전체 티켓 계획
- [Epic 1: 백테스트](../../../../docs/product/epics/epic-1-backtest.md) - 백테스트 관련
- [Epic 2: 전략 관리](../../../../docs/product/epics/epic-2-strategy.md) - 전략 관리
- [Epic 3: 마켓플레이스](../../../../docs/product/epics/epic-3-marketplace.md) - 전략 마켓

### API 명세
- [Predictions API](../../../../docs/api/predictions.md) - 예측 API
- [Stocks API](../../../../docs/api/stocks.md) - 종목 API
- [Trading API](../../../../docs/api/trading.md) - 트레이딩 API

### 프로젝트 문서
- [ERD](../../../../docs/erd.md) - 데이터베이스 스키마
